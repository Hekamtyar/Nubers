...
/**
 * Created by Hekmatyar on 2018/6/20.
 */
...
public class NumberHrdView extends View {
    ...
    private void iniPaint() {
        ...
        mPaint7=new Paint();
        mPaint7.setFlags(Paint.ANTI_ALIAS_FLAG);
        createPaint(mPaint7);

        mPaint8=new Paint();
        mPaint8.setFlags(Paint.ANTI_ALIAS_FLAG);
        createPaint(mPaint8);

        mPaint9=new Paint();
        mPaint9.setFlags(Paint.ANTI_ALIAS_FLAG);
        mPaint9.setColor(0x00);
        createPaint(mPaint9);
        ...
        switch (numberType){
            ...
            case 4://"4","5","3","7","6","2","8","1"
                if(       rect1.top==number_4_top&&rect1.bottom==number_4_bottom&&rect1.left==number_4_left&&rect1.right==number_4_right
                        ...
                        &&rect6.top==number_2_top&&rect6.bottom==number_2_bottom&&rect6.left==number_2_left&&rect6.right==number_2_right
                        &&rect7.top==number_8_top&&rect8.bottom==number_8_bottom&&rect7.left==number_8_left&&rect7.right==number_8_right
